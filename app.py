...
def load_model_results(learning_rate, tree_depth, n_estimators, random_state, val_size):
    ...
    val_results_path = f"https://raw.githubusercontent.com/JonathanBechtel/optimized-app/master/models/val_{learning_rate}_{tree_depth}_{n_estimators}_{random_state}_{val_size}.csv"
